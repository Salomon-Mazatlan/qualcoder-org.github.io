...
The default language of QualCoder is English. French, German  and Spanish are alternative regularly updated languages. Other languages have not been thoroughly reviewed for accuracy of translations (Chinese, Japanese, Portuguese, Romanian, Swedish). 
...
The **AI related options** at the bottom of the Settings dialog are described here: [AI Setup](https://qualcoder.org/doc/en/2.3.-AI-Setup)
