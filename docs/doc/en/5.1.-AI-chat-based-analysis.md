...
- Is based on the same search technology that also powers the [AI Assisted Coding](https://qualcoder.org/doc/en/4.2.-AI-Assisted-Coding). 

In the AI Chat tab, click on "New > New topic analysis chat", and the following window will appear:

<img src="https://github.com/user-attachments/assets/7639f64d-b083-48d0-bcd1-f84b4098b365" width=800em alt="Screenshot New topic analysis chat">
...
2) Select an **analytic prompt:**
   ...
   (As an advanced option, you can also define your own analytic prompts by clicking on the “Edit” button, which opens the [AI Prompt Library](https://qualcoder.org/doc/en/6.2.-AI-Prompt-Library).)
...
If you want to **define your own types of text analysis**, you can do so by adding them to the [AI Prompt Library](https://qualcoder.org/doc/en/6.2.-AI-Prompt-Library) (advanced option).
