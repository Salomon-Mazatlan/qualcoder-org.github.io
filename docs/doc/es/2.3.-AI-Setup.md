...
* __Para otras opciones de proveedores de IA [véase más abajo](https://qualcoder.org/doc/es/2.3.-AI-Setup/_edit#uso-de-otros-modelos-de-ia).__
...
Una vez completado el proceso de lectura, la barra de estado de la aplicación mostrará el mensaje "IA: ready" (Véase Imagen 8) y podrá comenzar a utilizar el [chat de IA](https://qualcoder.org/doc/es/5.1.-AI-chat-based-analysis) o la [codificación asistida por IA](https://qualcoder.org/doc/es/4.2.-AI-Assisted-Coding) para explorar sus datos.
