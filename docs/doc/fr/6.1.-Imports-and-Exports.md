...
À l'heure actuelle, QualCoder est capable d'importer un livre de codes à condition qu'il utilise la version « urn:QDA-XML:codebook:1.0 ». QualCoder exporte également dans cette version.
