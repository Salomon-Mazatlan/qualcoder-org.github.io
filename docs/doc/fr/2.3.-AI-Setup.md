...
![Capture d'écran des paramètres IA](https://github.com/user-attachments/assets/ad3c3467-debd-4632-aada-68e1291ab8f8)
...
2. **[Choisissez le modèle d’IA que vous souhaitez utiliser](#ai-model-selection)** et configurez-le.
3. La **[mémoire IA locale](#the-local-ai-memory-setup)** est ensuite configurée et créée automatiquement. Soyez patient, car cela peut prendre un certain temps.
4. L’agent IA dans QualCoder est alors **prêt** à l’emploi.

Vous pouvez également consulter [comment préparer au mieux votre projet à l'utilisation de l'IA](#améliorer-l'ergonomie-de-l'IA-dans-votre-projet) ainsi que nos [remarques sur la confidentialité des données](#quelques-remarques-sur-la-confidentialité-et-la-protection-des-données) ci-dessous.
...
![Message « AI : lecture en cours »](https://github.com/user-attachments/assets/04f268f9-d05e-431f-b4fd-d4eabf210a0b)
