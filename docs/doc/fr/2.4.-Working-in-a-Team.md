...
* Décidez d'une stratégie pour gérer les ⋅euses dans votre équipe, comme expliqué dans les notes ci-dessous.
...
## Considérations importantes concernant les ⋅euses
* Dans la plupart des cas, il est préférable d'attribuer un nom unique à chaque développeur de votre équipe afin de pouvoir identifier les contributions individuelles même après la fusion des projets.
* Dans Projet > Paramètres, cliquez sur le bouton « Modifier » situé à côté du nom du développeur pour ouvrir une fenêtre dans laquelle vous pouvez modifier votre propre identité ou créer, renommer ou fusionner d'autres développeurs au sein du projet en cours.
