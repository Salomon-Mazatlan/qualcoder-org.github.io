...
QualCoder is free software, built on contributions from the global community. A valuable contribution is translating it into your native language. We strive to ensure [linguistic diversity](https://qualcoder.org/community/). Please feel free to help us with translations, whether of the software itself or the documentation. Please contact us so that we can organise this.
